...
fn bindgen_test_layout_CK_KEA_DERIVE_PARAMS() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).RandomA) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(CK_KEA_DERIVE_PARAMS),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).RandomB) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(CK_KEA_DERIVE_PARAMS),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).PublicData) as usize - ptr as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(CK_KEA_DERIVE_PARAMS),
            "::",
            stringify!(PublicData)
        )
    );
}
...
fn bindgen_test_layout_CK_X9_42_MQV_DERIVE_PARAMS() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).OtherInfo) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(CK_X9_42_MQV_DERIVE_PARAMS),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).PublicData2) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(CK_X9_42_MQV_DERIVE_PARAMS),
            "::",
            stringify!(PublicData2)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).publicKey) as usize - ptr as usize },
