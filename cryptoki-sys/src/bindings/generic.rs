...
pub const CRYPTOKI_FORCE_WIN32: u32 = 1;
...
pub type CK_GCM_MESSAGE_PARAMS_PTR = CK_GCM_MESSAGE_PARAMS;
#[repr(C)]
#[cfg_attr(windows, repr(packed))]
#[derive(Debug, Copy, Clone)]
...
pub type CK_CCM_MESSAGE_PARAMS_PTR = CK_CCM_MESSAGE_PARAMS;
#[repr(C)]
#[cfg_attr(windows, repr(packed))]
#[derive(Debug, Copy, Clone)]
...
pub struct CK_SP800_108_KDF_PARAMS {
    ...
    pub pAdditionalDerivedKeys: CK_DERIVED_KEY,
}
...
pub struct Pkcs11 {
    ...
    pub C_Initialize:
        Result<unsafe extern "C" fn(pInitArgs: CK_VOID_PTR) -> CK_RV, ::libloading::Error>,
    pub C_Finalize:
        Result<unsafe extern "C" fn(pReserved: CK_VOID_PTR) -> CK_RV, ::libloading::Error>,
    pub C_GetInfo: Result<unsafe extern "C" fn(pInfo: CK_INFO_PTR) -> CK_RV, ::libloading::Error>,
    ...
    >,
    pub C_CloseSession:
        Result<unsafe extern "C" fn(hSession: CK_SESSION_HANDLE) -> CK_RV, ::libloading::Error>,
...
impl Pkcs11 {
    ...
    pub unsafe fn C_Initialize(&self, pInitArgs: CK_VOID_PTR) -> CK_RV {
        (self
            .C_Initialize
            .as_ref()
            .expect("Expected function, got error."))(pInitArgs)
    }
    pub unsafe fn C_Finalize(&self, pReserved: CK_VOID_PTR) -> CK_RV {
        (self
            .C_Finalize
            .as_ref()
            .expect("Expected function, got error."))(pReserved)
    }
    pub unsafe fn C_GetInfo(&self, pInfo: CK_INFO_PTR) -> CK_RV {
        (self
            .C_GetInfo
            .as_ref()
            .expect("Expected function, got error."))(pInfo)
    }
    ...
    pub unsafe fn C_GetSlotList(
        ...
        (self
            .C_GetSlotList
            .as_ref()
            .expect("Expected function, got error."))(tokenPresent, pSlotList, pulCount)
    }
    pub unsafe fn C_GetSlotInfo(&self, slotID: CK_SLOT_ID, pInfo: CK_SLOT_INFO_PTR) -> CK_RV {
        (self
            .C_GetSlotInfo
            .as_ref()
            .expect("Expected function, got error."))(slotID, pInfo)
    }
    pub unsafe fn C_GetTokenInfo(&self, slotID: CK_SLOT_ID, pInfo: CK_TOKEN_INFO_PTR) -> CK_RV {
        (self
            .C_GetTokenInfo
            .as_ref()
            .expect("Expected function, got error."))(slotID, pInfo)
    ...
    pub unsafe fn C_GetMechanismList(
        ...
        (self
            .C_GetMechanismList
            .as_ref()
            .expect("Expected function, got error."))(slotID, pMechanismList, pulCount)
    }
    pub unsafe fn C_GetMechanismInfo(
        ...
        (self
            .C_GetMechanismInfo
            .as_ref()
            .expect("Expected function, got error."))(slotID, type_, pInfo)
    }
    pub unsafe fn C_InitToken(
        ...
        (self
            .C_InitToken
            .as_ref()
            .expect("Expected function, got error."))(slotID, pPin, ulPinLen, pLabel)
    }
    pub unsafe fn C_InitPIN(
        ...
        (self
            .C_InitPIN
            .as_ref()
            .expect("Expected function, got error."))(hSession, pPin, ulPinLen)
    }
    ...
    pub unsafe fn C_CloseSession(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_CloseSession
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    }
    ...
    pub unsafe fn C_GetSessionInfo(
        ...
        (self
            .C_GetSessionInfo
            .as_ref()
            .expect("Expected function, got error."))(hSession, pInfo)
    }
    ...
    pub unsafe fn C_Login(
        ...
        (self
            .C_Login
            .as_ref()
            .expect("Expected function, got error."))(hSession, userType, pPin, ulPinLen)
    }
    pub unsafe fn C_Logout(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_Logout
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    ...
    pub unsafe fn C_CreateObject(
        ...
        (self
            .C_CreateObject
            .as_ref()
            .expect("Expected function, got error."))(hSession, pTemplate, ulCount, phObject)
    }
    ...
    pub unsafe fn C_DestroyObject(
        ...
        (self
            .C_DestroyObject
            .as_ref()
            .expect("Expected function, got error."))(hSession, hObject)
    }
    pub unsafe fn C_GetObjectSize(
        ...
        (self
            .C_GetObjectSize
            .as_ref()
            .expect("Expected function, got error."))(hSession, hObject, pulSize)
    }
    pub unsafe fn C_GetAttributeValue(
        ...
        (self
            .C_GetAttributeValue
            .as_ref()
            .expect("Expected function, got error."))(hSession, hObject, pTemplate, ulCount)
    }
    ...
    pub unsafe fn C_FindObjectsInit(
        ...
        (self
            .C_FindObjectsInit
            .as_ref()
            .expect("Expected function, got error."))(hSession, pTemplate, ulCount)
    }
    ...
    pub unsafe fn C_FindObjectsFinal(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_FindObjectsFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    ...
    pub unsafe fn C_EncryptInit(
        ...
        (self
            .C_EncryptInit
            .as_ref()
            .expect("Expected function, got error."))(hSession, pMechanism, hKey)
    }
    ...
    pub unsafe fn C_DecryptFinal(
        ...
        (self
            .C_DecryptFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession, pLastPart, pulLastPartLen)
    }
    pub unsafe fn C_DigestInit(
        ...
        (self
            .C_DigestInit
            .as_ref()
            .expect("Expected function, got error."))(hSession, pMechanism)
    }
    ...
    pub unsafe fn C_DigestUpdate(
        ...
        (self
            .C_DigestUpdate
            .as_ref()
            .expect("Expected function, got error."))(hSession, pPart, ulPartLen)
    }
    pub unsafe fn C_DigestKey(&self, hSession: CK_SESSION_HANDLE, hKey: CK_OBJECT_HANDLE) -> CK_RV {
        (self
            .C_DigestKey
            .as_ref()
            .expect("Expected function, got error."))(hSession, hKey)
    }
    pub unsafe fn C_DigestFinal(
        ...
        (self
            .C_DigestFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession, pDigest, pulDigestLen)
    }
    ...
    pub unsafe fn C_SignFinal(
        ...
        (self
            .C_SignFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession, pSignature, pulSignatureLen)
    }
    ...
    pub unsafe fn C_VerifyFinal(
        ...
        (self
            .C_VerifyFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession, pSignature, ulSignatureLen)
    }
    ...
    pub unsafe fn C_SeedRandom(
        ...
        (self
            .C_SeedRandom
            .as_ref()
            .expect("Expected function, got error."))(hSession, pSeed, ulSeedLen)
    }
    pub unsafe fn C_GenerateRandom(
        ...
        (self
            .C_GenerateRandom
            .as_ref()
            .expect("Expected function, got error."))(hSession, RandomData, ulRandomLen)
    }
    pub unsafe fn C_GetFunctionStatus(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_GetFunctionStatus
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    }
    pub unsafe fn C_CancelFunction(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_CancelFunction
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    ...
    pub unsafe fn C_WaitForSlotEvent(
        ...
        (self
            .C_WaitForSlotEvent
            .as_ref()
            .expect("Expected function, got error."))(flags, pSlot, pRserved)
    }
    pub unsafe fn C_GetInterfaceList(
        &self,
        ...
        (self
            .C_GetInterfaceList
            .as_ref()
            .expect("Expected function, got error."))(pInterfacesList, pulCount)
    }
    ...
    pub unsafe fn C_SessionCancel(&self, hSession: CK_SESSION_HANDLE, flags: CK_FLAGS) -> CK_RV {
        (self
            .C_SessionCancel
            .as_ref()
            .expect("Expected function, got error."))(hSession, flags)
    }
    ...
    pub unsafe fn C_MessageEncryptFinal(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_MessageEncryptFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    ...
    pub unsafe fn C_MessageDecryptFinal(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_MessageDecryptFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    ...
    pub unsafe fn C_SignMessageBegin(
        ...
        (self
            .C_SignMessageBegin
            .as_ref()
            .expect("Expected function, got error."))(hSession, pParameter, ulParameterLen)
    }
    ...
    pub unsafe fn C_MessageSignFinal(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_MessageSignFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession)
    ...
    pub unsafe fn C_MessageVerifyFinal(&self, hSession: CK_SESSION_HANDLE) -> CK_RV {
        (self
            .C_MessageVerifyFinal
            .as_ref()
            .expect("Expected function, got error."))(hSession)
